...
class DGGatedHippocampalMoE(OptimalHippocampalMoE):
    ...
    def __init__(self, num_experts, classes_per_task, input_channels, target_sparsity=0.05, memory_size=200, use_small_features=False):
        ...
        self.expected_input_height = 32
        self.expected_input_width = 32
        ...
        self.feature_to_ca1 = nn.Linear(feature_extractor_output_dim, 128)  # Raw 3×32×32 input -> 128 for legacy CA1 distillation
    ...
    def prepare_dg_input(self, x):
        ...
        Expected input: [batch, input_channels, 32, 32]
